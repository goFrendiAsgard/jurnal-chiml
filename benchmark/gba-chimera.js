                                ...
                                function __unit_0_1_1(raw) {
                                    ...
                                    function __fn_0_1_1() {
                                        if ((__first_0_1_1 && (true)) || (!__first_0_1_1 && false)) {
                                            /* JS Function with Node Callback : sys.httpRequest */
                                            function __unit_0_1_1_0() {
                                                var __first_0_1_1_0 = true;
                                                function __fn_0_1_1_0() {
                                                    if ((__first_0_1_1_0 && (true)) || (!__first_0_1_1_0 && false)) {
                                                        var __promise_0_1_1_0 = new Promise(function (__resolve, __reject) {
                                                            (index_js_1.sys.httpRequest)('http://localhost:3000/authors?id=' + raw.authorId, function (__error) {
                                                                var __result = [];
                                                                for (var _i = 1; _i < arguments.length; _i++) {
                                                                    __result[_i - 1] = arguments[_i];
                                                                }
                                                                ...
                                                                authors = __result.length === 0 ? undefined : (__result.length === 1 ? __result[0] : __result);
                                                                return __resolve(true);
                                                            });
                                                        });
                                                        __first_0_1_1_0 = false;
                                                        return __promise_0_1_1_0.then(function () { return __fn_0_1_1_0(); });
                                                    }
                                                    return Promise.resolve(authors);
                                                }
                                                return __fn_0_1_1_0().catch(function (__error) {
                                                    __error = __error && 'message' in __error ? __error : new Error(__error);
                                                    if (__error && !__error.__propagated) {
                                                        __error.message = [
                                                            "",
                                            ...
                                            function __main_0_1_1_0() {
                                                var __ins = [];
                                                for (var _i = 0; _i < arguments.length; _i++) {
                                                    __ins[_i] = arguments[_i];
                                                }
                                                return __unit_0_1_1_0.apply(void 0, __ins);
                                            }
                                            /* JS Function : (x) => x */
                                            function __unit_0_1_1_1() {
                                                var __first_0_1_1_1 = true;
                                                function __fn_0_1_1_1() {
                                                    if ((__first_0_1_1_1 && (true)) || (!__first_0_1_1_1 && false)) {
                                                        var __promise_0_1_1_1 = new Promise(function (__resolve, __reject) {
                                                            try {
                                                                result = (function (x) { return x; })({ title: raw.title, author: authors[0].name });
                                                                __resolve(true);
                                                            }
                                                            catch (__error) {
                                                                __reject(__error);
                                                        ...
                                                        __first_0_1_1_1 = false;
                                                        return __promise_0_1_1_1.then(function () { return __fn_0_1_1_1(); });
                                                    }
                                                    return Promise.resolve(result);
                                                }
                                                return __fn_0_1_1_1().catch(function (__error) {
                                                    __error = __error && 'message' in __error ? __error : new Error(__error);
                                                    if (__error && !__error.__propagated) {
                                                        __error.message = [
                                                            "",
                                            ...
                                            function __main_0_1_1_1() {
                                                var __ins = [];
                                                for (var _i = 0; _i < arguments.length; _i++) {
                                                    __ins[_i] = arguments[_i];
                                                }
                                                return __unit_0_1_1_1.apply(void 0, __ins);
                                            }
                                            var __promise_0_1_1 = Promise.resolve(true).then(function () { return __main_0_1_1_0(); }).then(function () { return __main_0_1_1_1(); });
                                            __first_0_1_1 = false;
